...
import { createGroup } from '../../feature/Slice/CreateGroup';
            ...
            <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl transform transition-all duration-300 max-h-[90vh] overflow-hidden">
                ...
                <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
                    ...
                    <div className="mb-6">
                        ...
                        >
                            <Plus size={18} />
                            <span className="font-medium">{showContacts ? 'Hide Members' : 'Select Members'}</span>
                        </button>

                        {/* Contact List */}
                        <div className={`mt-4 transition-all duration-300 ${showContacts ? 'opacity-100 max-h-96' : 'opacity-0 max-h-0 overflow-hidden'}`}>
