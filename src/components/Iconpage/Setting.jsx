...
function Setting() {
  ...
  const [showAvailble, setShowAvailble] = useState(false);  // Language Menu 
  const [activeSection, setActiveSection] = useState("personalinfo"); // switch case
  const [isMenuOpen, setIsMenuOpen] = useState(false); // Everyone action
            ...
            <div className='relative inline-block'>
              ...
              {showAvailble && (
                <div className='absolute top-full mt-2 left-0 w-32 bg-white rounded shadow-xl z-50'>
                  ...
                  >
                    <p className="text-base text-gray-700">Available</p>
                  </div>
                  <div
                    className='px-3 py-2 hover:bg-gray-100 cursor-pointer rounded-b-xl'
                    onClick={() => setShowAvailble(false)}
                  >
                    <p className="text-base text-gray-700">Busy</p>
                  </div>
                </div>
              )}
            </div>
              ...
              <div className='bg-white'>
                <div className='my-4 mt-2 space-y-3 text-sm text-gray-800 px-4 py-2.5 max-h-[37vh] overflow-auto'>
                  ...
                  <div className='flex justify-between items-center'>
                    <p className='text-base'>Profile photo</p>
                    <button className="flex items-center gap-2 bg-gray-200 hover:bg-gray-300 px-2 py-1 rounded text-sm text-black"
                      onClick={toggleMenu}>
                      <span>Everyone</span>
                      <ChevronDown className="w-4 h-4" />
                    </button>
                    {isMenuOpen && (
                      <div className="absolute right-5 top-12 w-40 bg-white border border-gray-200 rounded-md shadow-md z-10">
                  ...
                  <div className='flex justify-between items-center mb-4 relative'>
                    ...
                    <div className="relative">
                      ...
                      {isMenuOpen && (
                        <div className="absolute right-0 -top-36 w-40 bg-white border border-gray-200 rounded-lg shadow-lg z-10">
                          {everyonemenu.map(({ name, id }) => (
                            <div key={id}>
                              {name === "Another action" && <hr className="border-gray-300 mx-2" />}
                              <button
            ...
            {activeSection === "security" && (
              <div className='bg-white'>
                <div className="mt-2 space-y-3 text-sm text-gray-800 mb-4 px-4 py-2.5 max-h-[37vh] overflow-auto ">
                  {/*>Show security notification section*/}
                  <div className='flex justify-between items-center '>
              ...
              <div className='bg-white'>
                <div className="mt-2 space-y-3 text-sm text-gray-800 mb-4 px-4 py-2.5">
                  ...
                  <div className='flex gap-1 items-center'>
                    ...
                    <span className='text-base'>Terms & Privacy policy</span>
                  </div>
                </div>
              </div>
            )}
