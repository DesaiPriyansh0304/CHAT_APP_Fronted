...
import { toggleTheme } from '../feature/Slice/ThemeSlice';
...
function Sidebar() {
    ...
    const [clickEffect, setClickEffect] = useState(() => {
        ...
        return storedTab !== null ? parseInt(storedTab) : null;
    });
    ...
    const bottomItems = [
        ...
        { id: 102, icon: <MdOutlineLanguage size={26} />, title: 'Language', action: toggleLanguageMenu },
        // {
        //     id: 103,
        //     icon: isDarkMode ? <LuMoon size={24} /> : <LuSun size={24} />,
                ...
                <div className="relative w-full h-screen  flex flex-col items-center justify-between py-4 shadow-md">
                    ...
                    <div className="flex flex-col items-center relative">
                        ...
                        {showLangMenu && (
                            <div
                                ref={langMenuRef}
                                className="absolute bottom-24 left-16 w-40 bg-white border border-gray-200 rounded-md shadow-lg z-50 transition-all duration-200 ease-out
