  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchChatHistory.fulfilled, (state, action) => {
        const { messages, currentPage, totalPages, totalMessages, sender, receiver, groupUsers } =
          action.payload;
        ...
        const flattenedMessages = messages.map((msg) => {
          ...
          const senderEmail = typeof msg.senderId === 'object' ? msg.senderId.email : '';
          const receiverEmail = typeof msg.receiverId === 'object' ? msg.receiverId.email : '';
        ...
        state.messages =
          currentPage > 1 ? [...flattenedMessages, ...state.messages] : flattenedMessages;
...
export const { setMessages, addOwnMessage, clearMessages, setSearchQuery, markMessageAsRead } =
